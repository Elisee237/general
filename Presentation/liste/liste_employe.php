                        ...
                        <div style="height: 83px; width: 100%"> 
                            ...
                            <select class="form-select-sm" style="margin-left: 670px;margin-top: -50px;" name='tri'>
                                <optgroup label="Trier par :">
                                    <option value="matricule" selected="matricule"><a href="liste_employe.php?tri=1">Matricule</a></option>
                                    <option value="noms"><a href="liste_employe.php?tri=2">nom</a></option>
                                    <option value="nomService"><a href="liste_employe.php?tri=3">poste</a></option>
                                    <option value="nom"><a href="liste_employe.php?tri=3">poste</a></option>
